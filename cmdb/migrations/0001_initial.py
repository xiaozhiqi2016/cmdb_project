# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-10-20 10:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('switch', '交换机'), ('router', '路由器'), ('firewall', '防火墙'), ('storage', '存储设备'), ('NLB', '负载均衡'), ('wireless', '无线AP'), ('software', '软件资产'), ('others', '其它类')], default='server', max_length=64)),
